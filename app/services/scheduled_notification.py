...
class ScheduledNotificationService(
    ...
    async def publish_notifications(self):
        ...
        for scheduled_notification in scheduled_notifications:
            await self.publish_notification(scheduled_notification.id)

    async def publish_notification(self, scheduled_notification_id: uuid.UUID):
