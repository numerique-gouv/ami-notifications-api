...
PARTNERS_PSL_OTV_REQUEST_URL = os.getenv("PARTNERS_PSL_OTV_REQUEST_URL", "")
PARTNERS_PSL_OTV_JWT_CERT_PFX_B64 = os.getenv("PARTNERS_PSL_OTV_JWT_CERT_PFX_B64", "")
PARTNERS_PSL_OTV_JWT_CERT_PUBLIC_KEY = os.getenv("PARTNERS_PSL_OTV_JWT_CERT_PUBLIC_KEY", "")
PARTNERS_PSL_OTV_JWE_PUBLIC_KEY = os.getenv("PARTNERS_PSL_OTV_JWE_PUBLIC_KEY", "")

PARTNERS_DINUM_DN_SECRET = os.getenv("PARTNERS_DINUM_DN_SECRET", "")
assert PARTNERS_DINUM_DN_SECRET, "set a random PARTNERS_DINUM_DN_SECRET in your .env.local file"
PARTNERS_DINUM_AMI_SECRET = os.getenv("PARTNERS_DINUM_AMI_SECRET", "")
assert PARTNERS_DINUM_AMI_SECRET, "set a random PARTNERS_DINUM_AMI_SECRET in your .env.local file"

IGNORE_NOTIFICATION_REQUESTS_FOR_UNREGISTERED_USER = (
    os.getenv("IGNORE_NOTIFICATION_REQUESTS_FOR_UNREGISTERED_USER", "") == "true"
)
