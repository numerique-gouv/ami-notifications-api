...
import { dayName, holidayPeriod, retrieveHolidays } from '$lib/api-holidays.ts'
...
describe('/api-particulier.ts', () => {
  ...
  describe('holidayPeriod', () => {
    test('should not mention start date year', async () => {
      ...
      const endtDate = new Date('2025-11-15')

      // When
      const period = holidayPeriod(startDate, endtDate)
    ...
    test('should not mention start date year and month', async () => {
      // Given
      const startDate = new Date('2025-10-15')
      const endtDate = new Date('2025-10-20')
    ...
    test('should mention start date year and month', async () => {
      ...
      const endtDate = new Date('2026-01-02')
