<script lang="ts">
  ...
  const subscribePush = async () => {
    ...
    try {
      ...
      // $ uv run vapid-gen
      const applicationKey = "BNMNg_hRPF8toxsUCa7qx7iq-BAALLM5W9tG6ETSsXC2IKEkD9wgSAdhaleQAEELdZdmYoXdxY6KtURYgJLBpBo";
...
<div >
  ...
  <button type="button" onclick={askForNotificationPermission}>
  ...
  <p>
	...
	>
		<p>
			<label>Email for the registration
				<input
					type="text"
					id="register-email"
					name="register-email"
