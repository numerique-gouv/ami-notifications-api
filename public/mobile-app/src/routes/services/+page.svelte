    ...
    >
      <div class="services--container" data-testid="services">
        <div class="preferences-content-container">
          <nav
            class="fr-sidemenu services-sidemenu fr-px-2w"
  ...
  .services {
    ...
    .am-btn-target {
      &:after {
        ...
        mask-size: 100% 100%;
        --icon-size: 1rem;
        -webkit-mask-image: url("icons/custom/external-link-line.svg");
        mask-image: url("icons/custom/external-link-line.svg");
