...
WEB_APP_ACCESS_KEY_RATE_LIMIT = CONFIG.get("WEB_APP_ACCESS_KEY_RATE_LIMIT")
WEB_APP_ACCESS_KEY_RATE_LIMIT_DELAY = CONFIG.get("WEB_APP_ACCESS_KEY_RATE_LIMIT_DELAY")
...
FC_AMI_REDIRECT_URL = PUBLIC_APP_URL + "/login-callback"
...
FI_SILENT_LOGIN_ENABLED = CONFIG.get("PUBLIC_FEATURE_FLAG_SILENT_FC_ENABLED") == "true"
...
API_PARTICULIER_QUOTIENT_ENDPOINT = (
    f"/v3/dss/quotient_familial/france_connect?recipient={API_PARTICULIER_RECIPIENT_ID}"
)
API_PARTICULIER_QUOTIENT_BASE_URL = API_PARTICULIER_BASE_URL
API_PARTICULIER_QUOTIENT_SCOPE = CONFIG["API_PARTICULIER_QUOTIENT_SCOPE"]
API_PARTICULIER_QUOTIENT_ENABLED = CONFIG.get("API_PARTICULIER_QUOTIENT_ENABLED") == "true"
API_PARTICULIER_STATUT_ETUDIANT_BASE_URL = API_PARTICULIER_BASE_URL
API_PARTICULIER_STATUT_ETUDIANT_ENDPOINT = (
    f"/v3/mesri/statut_etudiant/france_connect?recipient={API_PARTICULIER_RECIPIENT_ID}"
)
API_PARTICULIER_STATUT_ETUDIANT_SCOPE = CONFIG["API_PARTICULIER_STATUT_ETUDIANT_SCOPE"]
API_PARTICULIER_STATUT_ETUDIANT_ENABLED = (
    CONFIG.get("API_PARTICULIER_STATUT_ETUDIANT_ENABLED") == "true"
)
...
CONSENT_DINUM_AMI_ENABLED = CONFIG.get("FEATURE_FLAG_CONSENT_DINUM_AMI_ENABLED") == "true"
CONSENT_DINUM_RDVSP_ENABLED = CONFIG.get("FEATURE_FLAG_CONSENT_DINUM_RDVSP_ENABLED") == "true"
