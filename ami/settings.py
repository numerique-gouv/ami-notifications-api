...
USERINFO_COOKIE_NAME = "ami-fi-userinfo"
...
FI_PUBLIC_KEY_PEM = CONFIG.get("FI_PUBLIC_KEY_PEM")
FI_PRIVATE_KEY_PEM = CONFIG.get("FI_PRIVATE_KEY_PEM")
FI_KEY_ID = CONFIG.get("FI_KEY_ID")

# Passkey options
PASSKEY_RP_NAME = CONFIG.get("PASSKEY_RP_NAME", "AMI")

# FC Hash options
FEATURE_FLAG_USE_FC_HASH_V2 = CONFIG.get("FEATURE_FLAG_USE_FC_HASH_V2") == "true"
