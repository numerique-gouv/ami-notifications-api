    ...
    def start_section(self, parents, child):
        ...
        try:
            ...
            if title_element is not None:
                section_title = node_to_markdown(title_element, mode="stripped").strip()
        ...
        section_id = hashlib.md5(ET.tostring(title_element)).hexdigest()[:4]
    ...
    def build_checklist(self, parents, condition=None):
        ...
        for child in parent:
            if child.tag == "Liste" and child.attrib.get("type") == "caseACocher":
                ...
                self.current_list.add_item(
                    child, section=self.current_section_id, condition=condition
                )
                continue
